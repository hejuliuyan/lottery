                ...
                <table class="insert-tab" width="100%">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="email"
                                   value="{{ $data[0]->email }}"/></td>
                    </tr>
                    <tr>
                        <th><i class="require-red">*</i>重置密码：</th>
                        <td><input type="text" name="password"
                                   value="{{ $data[0]->password }}"/></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><input name="state" type="radio" value="1"
                                   <?php if($data[0]->state == 1): ?> checked <?php endif; ?> />启用
                            <input name="state" type="radio" value="0"
                                   <?php if($data[0]->state == 0): ?> checked <?php endif; ?> />禁用
                        </td>
                    </tr>
                    <tr>
                        <th></th>
...
<script>
    $("#submit").click(function () {
        ...
        $.post("/index.php/ad_user_save", $("#formid").serialize(), function (data) {
            console.info(data);
            if (data == '1') {
